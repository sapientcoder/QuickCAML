<%@ Page Language="C#" masterpagefile="~masterurl/default.master" title="QuickCAML" inherits="Microsoft.SharePoint.WebPartPages.WebPartPage, Microsoft.SharePoint, Version=14.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" meta:progid="SharePoint.WebPartPage.Document" meta:webpartpageexpansion="full" %>
...
<p class="intro">
QuickCAML lets you test CAML queries quickly and easily right from your browser! 
Simply choose a list, define your query and options, and click the Execute 
button. You can also change sites within this site collection by changing the 
Site Url below.
<br /><br />
For help or feedback, please visit the QuickCAML GitHub page at <a href="https://github.com/inclinetechnical/QuickCAML" target="_new">
https://github.com/inclinetechnical/QuickCAML</a>. Use the &quot;Issues&quot; tab on the 
GitHub page to report issues or request features.
</p>
			...
			<div id="queryDefForm">
				<div class="field-row">
					...
					<div class="field-container">
						<div data-bind="visible: !editingSiteUrl()"><span data-bind="text: siteUrl"></span> 
							[<a href="" data-bind="click: changeSiteUrl">change</a>]</div>
						<div data-bind="visible: editingSiteUrl" style="display: none;">
							...
							[<a href="" data-bind="click: saveSiteUrl">save</a> 
							| <a href="" data-bind="click: function() { editingSiteUrl(false); }">
							cancel</a>]
						</div>
					</div>
				</div>
				<div class="field-row">
					...
					<div class="field-container">
						...
						<img src="/_layouts/images/gears_anv4.gif" class="loading-lists" data-bind="visible: loadingLists" alt="Loading lists..." />
					</div>
				</div>
		...
		<div class="section-content">
			...
			<div data-bind="with: queryResult">
				<p style="line-height: 20px;">
					...
					<strong>Item Count:</strong> <span data-bind="text: tabularData.rows.length"></span> <span data-bind="visible: (nextPage || currentPage &gt; 1)">
					(for this page)</span>
				</p>
				
				<p style="height: 25px;" data-bind="visible: (nextPage || currentPage &gt; 1)">
					[Page <span data-bind="text: currentPage"></span>]
					<a href="" data-bind="disable: $parent.executingQuery, visible: (nextPage), click: $parent.goToNextPage">
					Next  </a>
